<?php
    ...
    {
        $sql = "SELECT e.id, e.nome, p.nome pais FROM estado e JOIN pais p ON e.pais_id = p.id ORDER BY e.id DESC";
    }
...
<script>
    ...
    function searchData()
    {
        window.location = 'estado.php?search='+search.value;
    }
