<?php
    ...
    if(!empty($_GET['search']))
    {
        ...
        $sql = "SELECT * FROM pais WHERE nome LIKE '%$data%' or id LIKE '%$data%'";

    }
    else
    {
        $sql = "SELECT * FROM pais ORDER BY id DESC";
    }
...
<script>
    ...
    function searchData()
    {
        window.location = 'pais.php?search='+search.value;
    }
